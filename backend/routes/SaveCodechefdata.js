...
const scrapData = async (contestName,category) => {
    try {
...
router.post("/add", async (req, res) => {
    ...
    await scrapData(contestName,"A");
    await scrapData(contestName,"B");
    await scrapData(contestName,"C");
    await scrapData(contestName,"D");
    res.status(200).json({
